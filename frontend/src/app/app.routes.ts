...
export const routes: Routes = [
  ...
  { path: 'reports', loadComponent: () => import('./modules/reports/reports-dashboard.component').then(m => m.ReportsDashboardComponent), canActivate: [authGuard, roleGuard('ADMIN', 'MANAGER')] },
